...
// Icons
const SettingsIcon = ({ size = 22, color = Colors.dark.textSecondary }) => (
...
const FireIcon = ({ size = 20, color = '#FF6B35' }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
            d="M12 22C16.4183 22 20 18.4183 20 14C20 10.5 17.5 7.5 16 6C15.5 8 14 9 12 9C10 9 9 7 9 5C9 4 9.5 3 10 2C6 4 4 8 4 12C4 17.5228 7.58172 22 12 22Z"
            fill={color}
            stroke={color}
            strokeWidth={1}
            strokeLinecap="round"
...
export default function HomeScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {/* Top Bar with Settings and Streak */}
